...
namespace Monogame.Processing
{
    partial class Processing
    {
        ...
        {
            BeginSpriteBatch(SpriteSortMode.Immediate, transformMatrix: _matrix);
        ...
        {
            BeginSpriteBatch(SpriteSortMode.Immediate, samplerState: SamplerState.PointClamp, transformMatrix: _matrix);
        ...
        {
            BeginSpriteBatch(SpriteSortMode.Deferred, transformMatrix: _matrix);
